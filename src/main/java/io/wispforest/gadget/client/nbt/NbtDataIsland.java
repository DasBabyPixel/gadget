...
public class NbtDataIsland extends FlowLayout {
    ...
    void makeComponent(NbtPath path, Tag element) {
        ...
        if (element instanceof StringTag string) {
            ...
            if (reloader != null) {
                row.child(new PrimitiveEditorWidget(this, path, string.asString(), StringTag::valueOf));
            } else {
                rowText.append(Component.literal( string.asString() + " ")
                    .withStyle(ChatFormatting.GRAY));
            }
            ...
            if (reloader != null) {
                row.child(new PrimitiveEditorWidget(this, path, number.box(), text -> {
                ...
                rowText.append(Component.literal( number.box() + " ")
                    .withStyle(ChatFormatting.GRAY));
            }
